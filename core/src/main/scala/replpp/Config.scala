...
case class Config(
  ...
  def withAdditionalClasspathEntries(additionalEntries: Seq[Path]): Config =
    copy(classpathConfig = classpathConfig.withAdditionalClasspathEntries(additionalEntries))
