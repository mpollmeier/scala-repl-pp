...
/**
  * Copy of dotty.tools.repl.JLineTerminal with some adaptations
  * n.b. dotty is also Apache2 licensed: https://github.com/lampepfl/dotty/
  */
